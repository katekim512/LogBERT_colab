...
def generate_weights(ablation):
    output_dir = "/content/LogBERT_colab/output/hdfs/"
    vocab_path = os.path.join(output_dir, "vocab.pkl")
    template_csv_path = os.path.join(output_dir, "HDFS.log_templates.csv")
    structured_csv_path = os.path.join(output_dir, "HDFS.log_structured.csv")
...
if __name__ == "__main__":
    ...
    generate_weights(args.ablation)
